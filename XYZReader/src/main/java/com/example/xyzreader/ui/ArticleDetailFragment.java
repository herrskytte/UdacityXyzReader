    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView.findViewById(R.id.share_fab).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mCursor != null) {
                    String text = getString(R.string.share_text, mCursor.getString(ArticleLoader.Query.TITLE), mCursor.getString(ArticleLoader.Query.AUTHOR));
        ...
        if(mIsCard){
            ...
            params.width = getResources().getDimensionPixelSize(R.dimen.detail_card_max_width);
